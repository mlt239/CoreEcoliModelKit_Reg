...
function flux_variabilty_analysis(data_dictionary, additional_flux_constraints_array)
...
function calculate_optimal_flux_distribution2(data_dictionary) #modified, doesn't
    #include the additional flux array
